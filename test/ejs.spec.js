 ...
 * 测试 html 模板文件 ejs
 */
test('ko-layout.ejs', t => {
  try {
    const script = fs.readFileSync(resolve(__dirname, '../generators/app/templates/ko-component/ko-layout.ejs'), {encoding: 'utf8'})
    const options = {
      moduleName: 'user-image',
      modelName: 'userImg',
      moduleTitle: '查询影像平台',
